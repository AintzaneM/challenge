...
public class AccountsControllerTest {
  ...
  public void createTransaction () throws Exception {
    ...
    Account accountFrom = new Account(accountFromId, new BigDecimal("20"));
  ...
  public void createTransactionNegativeAmount() throws Exception {
    this.mockMvc.perform(post("/v1/accounts/transaction").contentType(MediaType.APPLICATION_JSON)
            .content("{\"transactionId\":\"Id-1\",\"amount\":-20 ,\"accountFrom\":\"Id-123\", \"accountTo\": \"Id-1234\"}")).andExpect(status().isBadRequest());
  }

  @Test
  public void makeTransactionEmptyBody() throws Exception {
    this.mockMvc.perform(post("/v1/accounts/transaction").contentType(MediaType.APPLICATION_JSON)
            .content("{}")).andExpect(status().isBadRequest());
  }

  @Test
  public void makeTransactionSameAccount() throws Exception {
    String accountFromId = "Id-123";
    Account accountFrom = new Account(accountFromId, new BigDecimal("20"));
    this.accountsService.createAccount(accountFrom);

    this.mockMvc.perform(post("/v1/accounts/transaction").contentType(MediaType.APPLICATION_JSON)
            .content("{\"accountFrom\":\"Id-123\",\"accountTo\":\"Id-123\",\"amount\":20}")).andExpect(status().isBadRequest());
  }
}
